...
\end{equation}
es una función compleja de la variable $z=\omega /k$, tambiñen compleja.El número de onda $k$ se asume como una cantidad real positiva y se utilizará la fórmula de Plemelj para lidiar con la singularidad del integrando.
