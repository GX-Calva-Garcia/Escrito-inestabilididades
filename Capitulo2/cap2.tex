...
El uso de funciones de distribución del plasma, el cual consiste en particulas cargadas con interacciones a larga distancia, indica que es necesaria una ecuación que describa la evolución temporal de estas. Dicha ecuación es conocida como la ecuación de Vlasov.\\
\begin{equation}
\label{eq:vlasov_def}
...
La ecuación \ref{eq:phi_inversa_laplace} es entonces una solución exacta al problema.
%%%%%%%Anderson%%%%%%%%%%%%%%%
